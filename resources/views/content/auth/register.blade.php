                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">MyCars - Criar conta</h1>
                                @if ($errors->any())
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ route('auth.login') }}">Já possui cadastro? <b>Faça o login aqui!</b></a>
                            </div>
                        </div>
                    </div>
                </div>
